...
public class CssXpathExamples {
    void cssXpathExamples() {
        ...
        $("input.login_form_input_box[name=email]#emil[data-testid=email]").setValue("1"); //не стоит
