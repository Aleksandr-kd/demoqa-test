...
//        executeJavaScript("$('#fixedban').remove()"); // удаляет баннер. селеинд выполнит код в консоле браузера ремове
...
//        $(".react-datepicker__month-select").selectOption("Jule");    // selectOption("August") выбирает месяц
//        $(".react-datepicker__year-select").selectOption("2008");    // selectOption("2020") выбирает год")
